...
ensures (r.dollars + cost.dollars) * 100
    ...
    //
    int givenFiftyCents = (fiveDollarNotes * 5) * 2
    int costInFiftyCents = (cost.dollars*2) + cost.fiftyCents
    return {dollars: 0, fiftyCents: givenFiftyCents - costInFiftyCents}